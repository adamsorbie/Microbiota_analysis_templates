...
pacman::p_load(microViz, microbiome, microbiomeutilities, seecolor, cowplot, shiny)
```
...
Having a look at the phyloegnetic composition of you data is useful for many reasons. 
...
numericInput("n_taxa", "How many taxa to show?", 8)

top_taxa <- c(get_top_n(ps, n=input$n_taxa, level = input$tax_rank), "other")
...
renderPlot({
    ...
    comp_fig <- ps %>% 
      ...
      comp_barplot(
        tax_level = input$tax?rank, n_taxa = input$n_taxa,
